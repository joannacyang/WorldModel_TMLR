...
from supports.main_world_gpt import getTokenLength
...
def parse_args():
    ...
    parser.add_argument(
        "--output_folder", type=str, default="rules/llm_generated_rules"
    )
...
def main():
    ...
    sorted_file_names = [
        filename
        for filename in sorted(os.listdir(args.game_code_folder))
