...
class Stove(Container, Device):
    def __init__(self):
        ...
        self.properties[
            "isMoveable"
        ] = False  # A stove is too heavy to move (and doesn't really need to be moved for this simulation)

        # Set critical properties
        self.properties[
            "maxTemperature"
        ] = 500.0  # Maximum temperature of the stove (in degrees Celsius)
        self.properties[
            "tempIncreasePerTick"
        ] = 25.0  # How much the temperature increases per tick (in degrees Celsius)
