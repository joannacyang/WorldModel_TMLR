...
class Room(Container):
    def __init__(self, name):
        ...
        self.connects = {
            ...
            "south": None,
            "west": None,
        }  # other rooms that this room connects to
...
class Shovel(GameObject):
    def __init__(self, name, durability=1):
        ...
        self.properties[
            "durability"
        ] = durability  # number of times the shovel can dig before broken
...
class TextGame:
    ...
    def initializeWorld(self):
        ...
        self.useful_info.append(agent_init_position)
        ...
        self.useful_info.append((positions[1] // 3, positions[1] % 3))
        ...
        for i in range(3):
            beach_map[positions[i + 2] // 3][positions[i + 2] % 3].bury(
                Item(possible_items[i])
            )

        # add a metal detector
        metal_detector = MetalDetector("metal detector")
        beach_map[agent_init_position[0]][agent_init_position[1]].addObject(
            metal_detector
        )
