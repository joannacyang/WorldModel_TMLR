...
class Freezer(Container, Device):
    def __init__(self):
        ...
        self.properties[
            "isMoveable"
        ] = False  # A freezer is too heavy to move (and doesn't really need to be moved for this simulation)

        self.properties["isOn"] = True  # A freezer is always on
        self.properties[
            "isActivatable"
        ] = False  # A freezer essentially never is turned off (unless it's unplugged, which is irelevant for this simulation)

        # Set critical properties
        self.properties["minTemperature"] = -4.0  # Minimum temperature of the freezer
        self.properties[
            "tempDecreasePerTick"
        ] = 5.0  # How much the temperature decreases per tick
