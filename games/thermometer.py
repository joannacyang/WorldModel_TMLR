...
class TextGame:
    ...
    def initializeWorld(self):
        ...
        # Randomly choose the the temperature of the water and the temperature of 2-5 distractors
    ...
    def actionTake(self, obj):
        ...
        # Cannot take liquid
        if type(obj) == Liquid:
            return f"You cannot take {obj.name} directly."
    ...
    def actionAnswer(self, temperature):
        ...
        return (
            f"You believe the temperature of the water is {temperature} Celsius degree."
        )
    ...
    def actionUse(self, deviceObj, patientObject):
        # Only a thermometer can be used in this game
        if type(deviceObj) == Thermometer:
            # the agent needs to take the thermometer before using it
