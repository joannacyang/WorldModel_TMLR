...
class TextGame:
    ...
    def initializeWorld(self):
        ...
        self.useful_info["cook_book"] = cook_book

        # Add a knife
        knife = Knife("knife")
        world.addObject(knife)

        self.useful_info["knife"] = knife
        ...
        self.useful_info["stove"] = stove
        self.useful_info["oven"] = oven
            ...
            for objReferent2, objs2 in allObjects.items():
                for obj1 in objs1:
                    for obj2 in objs2:
                        if obj1 != obj2:
                            self.addAction(
                                "slice " + objReferent1 + " with " + objReferent2,
                                ["slice", obj1, obj2],
                            )
                            self.addAction(
                                "dice " + objReferent1 + " with " + objReferent2,
                                ["dice", obj1, obj2],
                            )
                            self.addAction(
                                "chop " + objReferent1 + " with " + objReferent2,
                                ["chop", obj1, obj2],
                            )
                            self.addAction(
                                "cook " + objReferent1 + " in " + objReferent2,
                                ["cook", obj1, obj2],
                            )
    ...
    def get_demo_actions(self):
        ...
        cooking_actions = [
            ...
            # "cook patato (ID: 2) in oven (ID: 10)",
            # "take carrot (ID: 3)",
            # "cook carrot (ID: 3) in oven (ID: 10)",
            # "take onion (ID: 4)",
            # "dice onion (ID: 4) with knife (ID: 8)",
            # "cook onion (ID: 4) in stove (ID: 9)",
            # "take cucumber (ID: 5)",
            # "cook cucumber (ID: 5) in oven (ID: 10)",
        ]
