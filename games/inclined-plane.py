...
class InclinedPlane(Container):
    def __init__(self, name, acceleration, length):
        ...
        self.properties[
            "acceleration"
        ] = acceleration  # acceleration a block can have when putting on the inclined plane, reflects the angle of the inclined plane
        self.properties[
            "length"
        ] = length  # the length of the surface of the inclined plane
        self.properties[
            "objects"
        ] = {}  # record the number of ticks that the object is on the inclined plane
        ...
        if len(self.contains) == 0:
            ...
            for obj_name in self.properties["objects"]:
                distance = (
                    ...
                    * self.properties["objects"][obj_name] ** 2
                )
                ...
                obj_desc.append(
                    f"a {obj_name} approximately {rate*100}% down the plane"
                )
...
class TextGame:
    ...
    def initializeWorld(self):
        ...
        self.useful_info.append((self.a1, self.a2))
